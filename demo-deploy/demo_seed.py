...
# ---------------------------------------------------------------------------
DEVICES = [
    {"name": "Optimus (Edge Firewall)", "host": "10.0.1.1", "group": "Network", "checks": [("ping", "ICMP")]},
    {"name": "Megatron (Core Switch)", "host": "10.0.1.2", "group": "Network", "checks": [("ping", "ICMP")]},
    {"name": "Bender (Switch Floor 1)", "host": "10.0.1.3", "group": "Network", "checks": [("ping", "ICMP")]},
    {"name": "Fry (Switch Floor 2)", "host": "10.0.1.4", "group": "Network", "checks": [("ping", "ICMP")]},
    {"name": "Jarvis (Wireless Controller)", "host": "10.0.1.10", "group": "Network", "checks": [("ping", "ICMP")]},
    {"name": "Groot (AP Lobby)", "host": "10.0.1.11", "group": "Wireless", "checks": [("ping", "ICMP")]},
    {"name": "Rocket (AP Office)", "host": "10.0.1.12", "group": "Wireless", "checks": [("ping", "ICMP")]},
    {"name": "Chewy (AP Warehouse)", "host": "10.0.1.13", "group": "Wireless", "checks": [("ping", "ICMP")]},
    {"name": "Picard (Primary DC)", "host": "10.0.2.10", "group": "Servers", "checks": [("ping", "ICMP"), ("port", "DNS"), ("port", "LDAP")]},
    {"name": "Data (Backup DC)", "host": "10.0.2.11", "group": "Servers", "checks": [("ping", "ICMP"), ("port", "DNS"), ("port", "LDAP")]},
    {"name": "Yoda (File Server)", "host": "10.0.2.20", "group": "Servers", "checks": [("ping", "ICMP"), ("port", "SMB")]},
    {"name": "Wolverine (Web Server)", "host": "10.0.2.30", "group": "Servers", "checks": [("ping", "ICMP"), ("http", "HTTP"), ("port", "HTTPS")]},
    {"name": "Spock (SQL Server)", "host": "10.0.2.40", "group": "Servers", "checks": [("ping", "ICMP"), ("port", "SQL")]},
    {"name": "C3PO (Exchange Server)", "host": "10.0.2.50", "group": "Servers", "checks": [("ping", "ICMP"), ("port", "SMTP"), ("port", "HTTPS")]},
    {"name": "R2D2 (Backup Server)", "host": "10.0.2.60", "group": "Servers", "checks": [("ping", "ICMP")]},
    {"name": "Thanos (Hypervisor-01)", "host": "10.0.2.70", "group": "Servers", "checks": [("ping", "ICMP"), ("port", "Web UI")]},
    {"name": "Galactus (Hypervisor-02)", "host": "10.0.2.71", "group": "Servers", "checks": [("ping", "ICMP"), ("port", "Web UI")]},
    {"name": "Neo (VPN Gateway)", "host": "10.0.1.5", "group": "Network", "checks": [("ping", "ICMP"), ("port", "WireGuard")]},
    {"name": "Batman (NVR)", "host": "10.0.3.10", "group": "Security", "checks": [("ping", "ICMP"), ("port", "RTSP")]},
    {"name": "Scotty (VoIP PBX)", "host": "10.0.3.20", "group": "Infrastructure", "checks": [("ping", "ICMP"), ("port", "SIP")]},
    {"name": "Scooby (Printer Office)", "host": "10.0.3.30", "group": "Peripherals", "checks": [("ping", "ICMP")]},
    {"name": "Shaggy (Printer Warehouse)", "host": "10.0.3.31", "group": "Peripherals", "checks": [("ping", "ICMP")]},
    {"name": "Thor (UPS Server Room)", "host": "10.0.3.40", "group": "Infrastructure", "checks": [("ping", "ICMP"), ("port", "SNMP")]},
]
...
def seed_inventory(conn):
    ...
    assets = [
        ("10.0.1.1", "optimus", random_mac(), "Firewall", "Fortinet", "FortiGate 60F", "FortiOS 7.4.3", "Server Room Rack A", "FGT60F-SN-10284", "2024-03-15", "Primary perimeter firewall", "443,22,8443", "Optimus (Edge Firewall)"),
        ("10.0.1.2", "megatron", random_mac(), "Switch", "Cisco", "Catalyst 9300-48P", "IOS-XE 17.9", "Server Room Rack A", "FCW2438L0AB", "2023-08-22", "48-port PoE+ core switch", "22,23,80,443,161", "Megatron (Core Switch)"),
        ("10.0.1.3", "bender", random_mac(), "Switch", "Cisco", "2960X-24PS-L", "IOS 15.2", "Floor 1 IDF", "FOC2134V1K9", "2022-11-10", "Floor 1 distribution", "22,23,80,161", "Bender (Switch Floor 1)"),
        ("10.0.1.4", "fry", random_mac(), "Switch", "Cisco", "2960X-24PS-L", "IOS 15.2", "Floor 2 IDF", "FOC2134V1L2", "2022-11-10", "Floor 2 distribution", "22,23,80,161", "Fry (Switch Floor 2)"),
        ("10.0.1.10", "jarvis", random_mac(), "Wireless Controller", "Ubiquiti", "Dream Machine Pro", "UniFi OS 3.2", "Server Room Rack B", "UDMPRO-SN-38291", "2024-01-20", "UniFi wireless controller", "22,443,8443", "Jarvis (Wireless Controller)"),
        ("10.0.1.11", "groot", random_mac(), "Access Point", "Ubiquiti", "U6-Pro", "6.6.65", "Lobby ceiling", "U6PRO-SN-19283", "2024-01-20", "", "22", "Groot (AP Lobby)"),
        ("10.0.1.12", "rocket", random_mac(), "Access Point", "Ubiquiti", "U6-Pro", "6.6.65", "Open office ceiling", "U6PRO-SN-19284", "2024-01-20", "", "22", "Rocket (AP Office)"),
        ("10.0.1.13", "chewy", random_mac(), "Access Point", "Ubiquiti", "U6-LR", "6.6.65", "Warehouse high-mount", "U6LR-SN-48271", "2024-01-20", "", "22", "Chewy (AP Warehouse)"),
        ("10.0.2.10", "picard", random_mac(), "Server", "Dell", "PowerEdge R750", "Windows Server 2022", "Server Room Rack B", "DELL-SVC-7382910", "2023-06-15", "Primary AD DC, DNS, DHCP", "53,88,135,389,445,636,3389", "Picard (Primary DC)"),
        ("10.0.2.11", "data", random_mac(), "Server", "Dell", "PowerEdge R750", "Windows Server 2022", "Server Room Rack B", "DELL-SVC-7382911", "2023-06-15", "Secondary AD DC", "53,88,135,389,445,636,3389", "Data (Backup DC)"),
        ("10.0.2.20", "yoda", random_mac(), "NAS", "Synology", "RS1221+", "DSM 7.2.1", "Server Room Rack C", "SYN-RS1221-29481", "2023-01-10", "48TB RAID6 file storage", "22,80,443,445,5001", "Yoda (File Server)"),
        ("10.0.2.30", "wolverine", random_mac(), "Server", "HP", "ProLiant DL380 Gen10", "Windows Server 2022", "Server Room Rack B", "HP-SVC-9182734", "2022-09-01", "IIS web applications", "80,443,3389", "Wolverine (Web Server)"),
        ("10.0.2.40", "spock", random_mac(), "Server", "Dell", "PowerEdge R750", "Windows Server 2022", "Server Room Rack C", "DELL-SVC-8472910", "2023-06-15", "SQL Server 2022 Standard", "1433,3389", "Spock (SQL Server)"),
        ("10.0.2.50", "c3po", random_mac(), "Server", "Dell", "PowerEdge R750xs", "Windows Server 2022", "Server Room Rack C", "DELL-SVC-5738291", "2023-03-20", "Exchange 2019 on-prem", "25,80,443,587,993,995,3389", "C3PO (Exchange Server)"),
        ("10.0.2.60", "r2d2", random_mac(), "Server", "HP", "ProLiant DL380 Gen10", "Windows Server 2022", "Server Room Rack D", "HP-SVC-2839174", "2022-09-01", "Veeam B&R v12", "9443,3389", "R2D2 (Backup Server)"),
        ("10.0.2.70", "thanos", random_mac(), "Hypervisor", "Dell", "PowerEdge R760", "Proxmox VE 8.2", "Server Room Rack D", "DELL-SVC-6482910", "2024-06-01", "128GB RAM, Dual Xeon Gold", "22,8006", "Thanos (Hypervisor-01)"),
        ("10.0.2.71", "galactus", random_mac(), "Hypervisor", "Dell", "PowerEdge R760", "Proxmox VE 8.2", "Server Room Rack D", "DELL-SVC-6482911", "2024-06-01", "128GB RAM, Dual Xeon Gold", "22,8006", "Galactus (Hypervisor-02)"),
        ("10.0.1.5", "neo", random_mac(), "VPN Gateway", "Linux", "Custom WireGuard", "Ubuntu 24.04 LTS", "Server Room Rack A", "", "2024-02-28", "WireGuard remote access VPN", "22,51820", "Neo (VPN Gateway)"),
        ("10.0.3.10", "batman", random_mac(), "NVR", "Hikvision", "DS-7616NI-K2", "V4.62", "Security closet", "HIK-NVR-19284", "2023-09-15", "16-channel NVR", "80,554,8000", "Batman (NVR)"),
        ("10.0.3.20", "scotty", random_mac(), "PBX", "3CX", "Dedicated", "3CX v20", "Server Room Rack A", "", "2024-04-01", "3CX Phone System - 50 extensions", "80,443,5001,5060,5061", "Scotty (VoIP PBX)"),
        ("10.0.3.30", "scooby", random_mac(), "Printer", "HP", "LaserJet Enterprise M507", "2506A", "Main office - copy room", "CNBRF29381", "2023-05-10", "", "80,443,9100,515", "Scooby (Printer Office)"),
        ("10.0.3.31", "shaggy", random_mac(), "Printer", "Zebra", "ZT411", "V82.20.15Z", "Warehouse shipping desk", "ZBR-ZT411-8291", "2024-07-20", "Label printer - in maintenance", "80,9100", "Shaggy (Printer Warehouse)"),
        ("10.0.3.40", "thor", random_mac(), "UPS", "APC", "Smart-UPS SRT3000", "UPS 11.0", "Server Room Rack A", "APC-SRT3K-29481", "2022-06-01", "3000VA - SNMP card installed", "80,161", "Thor (UPS Server Room)"),
    ]
