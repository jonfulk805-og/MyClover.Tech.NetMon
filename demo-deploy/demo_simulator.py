...
DEVICES = [
    {"name": "Edge Firewall", "host": "10.0.1.1", "group": "Network",
     "checks": [("ping", "ICMP")], "base_ms": 2, "fail_rate": 0.005},
    {"name": "Core Switch", "host": "10.0.1.2", "group": "Network",
     "checks": [("ping", "ICMP")], "base_ms": 1.5, "fail_rate": 0.003},
    {"name": "Distribution Switch A", "host": "10.0.1.3", "group": "Network",
     "checks": [("ping", "ICMP")], "base_ms": 2, "fail_rate": 0.005},
    {"name": "Distribution Switch B", "host": "10.0.1.4", "group": "Network",
     "checks": [("ping", "ICMP")], "base_ms": 2, "fail_rate": 0.005},
    {"name": "Wireless Controller", "host": "10.0.1.10", "group": "Network",
     "checks": [("ping", "ICMP")], "base_ms": 3, "fail_rate": 0.005},
    {"name": "Office AP-1", "host": "10.0.1.11", "group": "Wireless",
     "checks": [("ping", "ICMP")], "base_ms": 8, "fail_rate": 0.01},
    {"name": "Office AP-2", "host": "10.0.1.12", "group": "Wireless",
     "checks": [("ping", "ICMP")], "base_ms": 8, "fail_rate": 0.01},
    {"name": "Office AP-3", "host": "10.0.1.13", "group": "Wireless",
     "checks": [("ping", "ICMP")], "base_ms": 12, "fail_rate": 0.02},
    {"name": "DC-01 (Domain Controller)", "host": "10.0.2.10", "group": "Servers",
     "checks": [("ping", "ICMP"), ("port", "DNS"), ("port", "LDAP")], "base_ms": 3, "fail_rate": 0.002},
    {"name": "DC-02 (Backup DC)", "host": "10.0.2.11", "group": "Servers",
     "checks": [("ping", "ICMP"), ("port", "DNS"), ("port", "LDAP")], "base_ms": 3, "fail_rate": 0.002},
    {"name": "File Server", "host": "10.0.2.20", "group": "Servers",
     "checks": [("ping", "ICMP"), ("port", "SMB")], "base_ms": 4, "fail_rate": 0.005},
    {"name": "Web Server (IIS)", "host": "10.0.2.30", "group": "Servers",
     "checks": [("ping", "ICMP"), ("http", "HTTP"), ("port", "HTTPS")], "base_ms": 5, "fail_rate": 0.008},
    {"name": "SQL Server", "host": "10.0.2.40", "group": "Servers",
     "checks": [("ping", "ICMP"), ("port", "SQL")], "base_ms": 3, "fail_rate": 0.005},
    {"name": "Exchange Server", "host": "10.0.2.50", "group": "Servers",
     "checks": [("ping", "ICMP"), ("port", "SMTP"), ("port", "HTTPS")], "base_ms": 5, "fail_rate": 0.008},
    {"name": "Backup Server", "host": "10.0.2.60", "group": "Servers",
     "checks": [("ping", "ICMP")], "base_ms": 4, "fail_rate": 0.003},
    {"name": "Hypervisor-01", "host": "10.0.2.70", "group": "Servers",
     "checks": [("ping", "ICMP"), ("port", "Web UI")], "base_ms": 2, "fail_rate": 0.003},
    {"name": "Hypervisor-02", "host": "10.0.2.71", "group": "Servers",
     "checks": [("ping", "ICMP"), ("port", "Web UI")], "base_ms": 2, "fail_rate": 0.003},
    {"name": "VPN Gateway", "host": "10.0.1.5", "group": "Network",
     "checks": [("ping", "ICMP"), ("port", "WireGuard")], "base_ms": 3, "fail_rate": 0.005},
    {"name": "IP Camera NVR", "host": "10.0.3.10", "group": "Security",
     "checks": [("ping", "ICMP"), ("port", "RTSP")], "base_ms": 5, "fail_rate": 0.01},
    {"name": "VoIP PBX", "host": "10.0.3.20", "group": "Infrastructure",
     "checks": [("ping", "ICMP"), ("port", "SIP")], "base_ms": 4, "fail_rate": 0.005},
    {"name": "Printer - Main Office", "host": "10.0.3.30", "group": "Peripherals",
     "checks": [("ping", "ICMP")], "base_ms": 12, "fail_rate": 0.015},
    {"name": "Printer - Warehouse", "host": "10.0.3.31", "group": "Peripherals",
     "checks": [("ping", "ICMP")], "base_ms": 20, "fail_rate": 0.15},  # In maintenance, flaky
    {"name": "UPS - Server Room", "host": "10.0.3.40", "group": "Infrastructure",
